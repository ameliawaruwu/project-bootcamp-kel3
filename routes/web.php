...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/orders/{order}/payment/error', [PaymentController::class, 'error'])->name('payment.error');
    Route::post('/orders/{order}/payment/check', [PaymentController::class, 'checkStatus'])->name('payment.check');
...
// Midtrans notification callback (no auth required - Midtrans will call this)
